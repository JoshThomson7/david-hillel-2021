...
<div class="apf__results__filter">
    ...
    <div class="apf__results__filter__view">
        ...
        <label class="apf-mobile-search"><i class="fal fa-search"></i></label>
    ...
    <div class="apf__results__filter__sort">
        ...
        <?php if($apf_settings->search_new_home()): ?>
            <article>
                <input type="checkbox" id="apf_new_homes" name="apf_new_homes" class="apf-fetch" value="true"<?php if($apf_new_homes == 'true') { echo " checked";} ?>>
        ...
        <?php if($apf_settings->search_hide_gone()): ?>
            <article>
                ...
                <label for="apf_status" class="apf__status">Hide Sold, Sold STC &amp; Under offer</label>
            </article>
        <?php endif; ?>
        ...
        ?>
            <select name="apf_branch" class="apf-fetch-on-change">
